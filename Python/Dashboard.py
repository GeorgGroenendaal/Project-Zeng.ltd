...
class Dashboard(QWidget):
    ...
    def addTab(self, number):   #
        if number == 1:
            ...
            self.tabWidget.addTab(self.w2.SunScreen1, "Sun Screen 2")
        elif number == 3:
            self.tabWidget.addTab(self.w3.SunScreen1, "Sun Screen 3")
        elif number == 4:
            self.tabWidget.addTab(self.w4.SunScreen1, "Sun Screen 4")
        else:
